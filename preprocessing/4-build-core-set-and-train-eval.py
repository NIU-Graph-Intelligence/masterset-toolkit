...
EVAL_YEAR = 2025
ROOT_DIR = Path("../data")
DATAFRAME_DIR = ROOT_DIR / "train_eval_set/v1.0"
...
def main():
    ...
    papers_df = pd.read_parquet(DATAFRAME_DIR / "all_papers_with_refs_and_labels_v2.0.parquet")
    ...
    # Save
    core_papers_df.to_parquet(DATAFRAME_DIR / "core_papers_v2.1.parquet", engine="pyarrow", index=False)
    core_papers_df.to_csv(DATAFRAME_DIR / "core_papers_v2.1.csv", index=False)
    training_papers_df.to_parquet(DATAFRAME_DIR / "train_v2.1.parquet", engine="pyarrow", index=False)
    training_papers_df.to_csv(DATAFRAME_DIR / "train_v2.1.csv", index=False)
    evaluation_papers_df.to_parquet(DATAFRAME_DIR / "eval_v2.1.parquet", engine="pyarrow", index=False)
    evaluation_papers_df.to_csv(DATAFRAME_DIR / "eval_v2.1.csv", index=False)
