"""Command-line interface for GROBID processor"""
...
def parse_arguments(args: List[str]) -> tuple:
    ...
    Expected formats:
    - grobid.py icml
    - grobid.py aistats 2025
    - grobid.py emnlp 2022 2023 2024
...
def print_usage():
    ...
    config = Config()
    print("=" * 60)
    print("GROBID TEI XML Processor - Usage")
    print("=" * 60)
    print("\nUsage:")
    print("  python grobid.py <conference> [year1] [year2] ...")
    print("\nExamples:")
    print("  python grobid.py icml                    # Process all years")
    print("  python grobid.py aistats 2025            # Process only 2025")
    print("  python grobid.py emnlp 2022 2023 2024    # Process multiple years")
